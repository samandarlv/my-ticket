...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joy rasmini qo'shish" }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joylarni rasminilarini ko'rish" }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joylarni rasminilarini id orqali ko'rish" }),
    (0, common_1.Get)(":id"),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joylarni rasminilarini id orqali yangilash" }),
    (0, common_1.Put)(":id"),
    __param(0, (0, common_1.Param)("id")),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joylarni rasminilarini id orqali o'chirish" }),
...
exports.VenuePhotoController = VenuePhotoController = __decorate([
    (0, swagger_1.ApiTags)("Joylar rasmlari"),
