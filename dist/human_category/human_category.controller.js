...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Kategoriyani id orqali ko'rish" }),
    (0, common_1.Get)(":id"),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Kategoriyalarni id orqali yangilash" }),
    (0, common_1.Put)(":id"),
    __param(0, (0, common_1.Param)("id")),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Kategoriyalarni id orqali o'chirish" }),
...
exports.HumanCategoryController = HumanCategoryController = __decorate([
    (0, swagger_1.ApiTags)("Kirish uchun toifalar/kategoriya"),
