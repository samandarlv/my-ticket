...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Yangi o'rindiq qo'shish" }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlarni ko'rish" }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlarni id orqali ko'rish" }),
    (0, common_1.Get)(":id"),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlarni id orqali yangilash" }),
    (0, common_1.Patch)(":id"),
    __param(0, (0, common_1.Param)("id")),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlarni id orqali o'chirish" }),
...
exports.SeatController = SeatController = __decorate([
    (0, swagger_1.ApiTags)("O'rindiqlar"),
