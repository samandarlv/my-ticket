...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Yangi o'rindiq tipini qo'shish" }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlar tiplarini ko'rish" }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlar tipini id orqali ko'rish" }),
    (0, common_1.Get)(":id"),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlar tipini id orqali yangilash" }),
    (0, common_1.Patch)(":id"),
    __param(0, (0, common_1.Param)("id")),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "O'rindiqlar tipini id orqali o'chirish" }),
...
exports.SeatTypeController = SeatTypeController = __decorate([
    (0, swagger_1.ApiTags)("O'rindiqlar tiplari"),
