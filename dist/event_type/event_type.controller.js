...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Yangi marosim turini qo'shish" }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Marosim turlarini ko'rish" }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Marosim turini id orqali ko'rish" }),
    (0, common_1.Get)(":id"),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Marosim turini id orqali yangilash" }),
    (0, common_1.Put)(":id"),
    __param(0, (0, common_1.Param)("id")),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Marosim turini id orqali o'chirish" }),
...
exports.EventTypeController = EventTypeController = __decorate([
    (0, swagger_1.ApiTags)("Marosim turlari"),
