...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joy turini qo'shish" }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Hamma joy turlarini ko'rish" }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joy turini id orqali ko'rish" }),
    (0, common_1.Get)(":id"),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joy turini id orqali yangilash" }),
    (0, common_1.Put)(":id"),
    __param(0, (0, common_1.Param)("id")),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Joy turini id orqali o'chirish" }),
